...
export default {
    ...
    methods: {
        ...
        initUserInfo(pageSize, currentPage, val) {
            ...
            axios
            .get('/api/studentInfo/queryLimitUser',{params})
            .then(res => {
                if(res.data.code === 200){
        ...
        downloadFile(){
            ...
            if(this.tagEmpty) {
               ...
               let params = {
                ...
                axios
                .post('/api/studentInfo/queryAllFilter',params)
                .then(res => {
                    if(res.data.code === 200){
        ...
        handleEdit(index, row) {
            this.$router.push(`/studentInfo/${row.user_id}/isedit`);
        },
        // 禁用按钮
