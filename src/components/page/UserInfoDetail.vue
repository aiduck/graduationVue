    ...
    <div class="wrap">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-profile"></i> 用户基本信息/用户详细信息</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="用户类型">
                                <el-select v-model="userForm.user_type_name" placeholder="请选择用户状态" :disabled="ischeck">
...
export default {
    ...
    methods: {
        ...
        // 去修改界面
        leaveFor() {
            this.$router.push(`/userDetails/${this.$route.params.userId}/isedit`);
        },
        // 重置密码
        resetPwd() {
            let params = {
